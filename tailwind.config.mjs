  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, #275A6D 0%, #E49B0B 50%, #207348 100%)',
        'cta-gradient': 'linear-gradient(90deg, #E49B0B 0%, #275A6D 100%)',
        'accent-gradient': 'linear-gradient(180deg, #207348 0%, #E49B0B 100%)',
      ...
      boxShadow: {
        ...
        'glow-green': '0 0 30px rgba(32, 115, 72, 0.3)',
