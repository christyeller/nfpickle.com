        ...
        <div className="container-custom relative z-10">
          <ScrollReveal className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We&apos;re thrilled to announce a community effort to bring <strong>8 dedicated pickleball courts</strong> and <strong>4 dedicated tennis courts</strong> to the North Fork Valley! To make this vision a reality, the <strong>North Fork Pickleball Club</strong> has established a 501(c)(3) nonprofit organization and is partnering with <strong>Delta County</strong> and the <strong>North Fork Pool, Park &amp; Recreation District</strong>, with the potential for future collaboration with the <strong>Delta County School District</strong>, to develop an exciting new recreational complex at the Delta County Fairgrounds. The project will create a centrally located hub for players from Paonia, Hotchkiss, Crawford, and the entire North Fork Valley. Beyond providing year-round opportunities for recreation, fitness, and social connection, the facility will also give the <strong>North Fork High School Tennis Team</strong> a true home venue for practices, matches, and future competition. Together, we&apos;re creating a place where neighbors can gather, families can play, and our community can enjoy the lifelong benefits of paddle and racquet sports for generations to come.
            </p>
          </ScrollReveal>
