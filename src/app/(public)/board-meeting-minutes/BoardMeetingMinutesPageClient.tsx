...
interface BoardMeetingMinutesPageClientProps {
  posts: (Post & { Media: Media | null })[]
}

export default function BoardMeetingMinutesPageClient({ posts }: BoardMeetingMinutesPageClientProps) {
      ...
      >
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            ...
            >
              <span className="text-white">Board Meeting Minutes</span>
            </motion.h1>
            ...
            >
              Minutes from North Fork Pickleball Club board meetings
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="container-custom">
          {posts.length > 0 ? (
            ...
            <div className="text-center py-12 text-gray-500">
              <p className="text-lg">No board meeting minutes yet</p>
